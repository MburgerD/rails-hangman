Feature: New Game
	...
	I want to a link to get to the games page
...
Scenario: User clicks the link to games on the home page
	When I am on the homepage
	And I click on the link to games
	Then I should go the games page
	Then I should see a link to new game

Scenario: User clicks the link to new game
